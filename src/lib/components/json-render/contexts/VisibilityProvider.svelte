<script module lang="ts">
	...
	export function getVisibilityContext(): VisibilityContext {
		...
		if (!ctx) {
			throw new Error('getVisibilityContext must be called within a VisibilityProvider');
		}
		return ctx;
	}
	 ...
	 */
	export function isVisible(condition: VisibilityCondition | undefined): CurrentValue<boolean> {
