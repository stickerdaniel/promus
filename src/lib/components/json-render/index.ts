...
export { flatToTree, buildSpecFromParts, getTextFromParts, type DataPart } from './utils.svelte.js';
...
export { default as CatalogRenderer, type CatalogRendererProps } from './CatalogRenderer.svelte';
export { default as JsonUIProvider, type JSONUIProviderProps } from './JsonUIProvider.svelte';
...
export type { Spec, UIElement, ActionBinding, ActionHandler } from '@json-render/core';
