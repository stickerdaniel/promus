...
{#if banned}
	<span
		class="inline-flex items-center rounded-md bg-destructive px-2 py-1 text-xs font-medium text-destructive-foreground ring-1 ring-destructive/20 ring-inset"
		data-testid={testId}
	>
